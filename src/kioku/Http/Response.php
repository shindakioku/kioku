...
class Response
{
     ...
     * @return Response
     */
    public function setHeader(string $key): Response
    {
        header($key);
     ...
     * @return Response
     */
    public function setContent(string $value): Response
    {
    ...
    {
        $this->relocation($_SERVER['HTTP_REFERER']);
